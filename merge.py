...
base = tk.Canvas(root2, width = 500, height = 500,bg='light cyan')
base.pack()
...
foot = tk.Canvas(root2, width = 500, height = 5, bg='black')
foot.pack()
