...
base = tk.Canvas(root, width = 400, height = 540,bg='light cyan')
base.pack()

foot = tk.Canvas(root, width = 400, height = 5, bg='black')
foot.pack()
